const posts = [
  {
    ...
    category: "Skincare",
    image: "/Kyora_beauty/assets/images/danhaycam.png",
    desc: "Quy trình dưỡng da nhẹ nhàng giúp da phục hồi sau một ngày dài.",
    content: `
      <img src="/Kyora_beauty/assets/images/danhaycam.png">
...

  {
    ...
    category: "Makeup",
    image: "/Kyora_beauty/assets/images/makeuppastel.png",
    desc: "Phong cách trang điểm nhẹ nhàng, trong veo đang lên ngôi.",
    content: `
      <img src="/Kyora_beauty/assets/images/makeuppastel.png">
...

  {
    ...
    category: "Skincare",
    image: "/Kyora_beauty/assets/images/suaruamat.png",
    desc: "Không phải sữa rửa mặt đắt tiền là tốt cho mọi làn da.",
    content: `
      <img src="/Kyora_beauty/assets/images/suaruamat.png">
...

  {
    ...
    category: "Routine",
    image: "/Kyora_beauty/assets/images/routine.png",
    desc: "Quy trình gọn nhẹ giúp da thông thoáng cả ngày.",
    content: `
      <img src="/Kyora_beauty/assets/images/routine.png">
...

  {
    ...
    category: "Skincare",
    image: "/Kyora_beauty/assets/images/toner.png",
    desc: "Những sản phẩm toner được bác sĩ da liễu khuyên dùng.",
    content: `
      <img src="/Kyora_beauty/assets/images/toner.png">
...

  {
    ...
    category: "Makeup",
    image: "/Kyora_beauty/assets/images/cleangirl.png",
    desc: "Trang điểm như không trang điểm đang rất được ưa chuộng.",
    content: `
      <img src="/Kyora_beauty/assets/images/cleangirl.png">
  ...
  },
  {
    ...
    category: "Skincare",
    image: "/Kyora_beauty/assets/images/streatment.png",
    desc: "Giúp da nhanh khỏe lại sau peel, laser.",
    content: `<img src="/Kyora_beauty/assets/images/streatment.png">
...

  {
    ...
    category: "Makeup",
    image: "/Kyora_beauty/assets/images/sonnude.png",
    desc: "Chọn son nude không khiến gương mặt bị nhợt nhạt.",
    content: `<img src="/Kyora_beauty/assets/images/sonnude.png">
...

  {
    ...
    category: "Routine",
    image: "/Kyora_beauty/assets/images/skincaremuahe.png",
    desc: "Giữ da thông thoáng, hạn chế đổ dầu.",
    content: `<img src="/Kyora_beauty/assets/images/skincaremuahe.png">
...

  {
    ...
    category: "Skincare",
    image: "/Kyora_beauty/assets/images/pbda.png",
    desc: "Rất nhiều người nhầm lẫn hai tình trạng này.",
    content: `<img src="/Kyora_beauty/assets/images/pbda.png">
...

  {
    ...
    category: "Makeup",
    image: "/Kyora_beauty/assets/images/makeuptiec.png",
    desc: "Vừa nổi bật vừa không quá đậm.",
    content: `<img src="/Kyora_beauty/assets/images/makeuptiec.png">
...

  {
    ...
    category: "Skincare",
    image: "/Kyora_beauty/assets/images/serum.png",
    desc: "Không cần dùng serum quá mạnh.",
    content: `<img src="/Kyora_beauty/assets/images/serum.png"><p>Nên bắt đầu với serum cấp ẩm.</p>`
  },

  {
    ...
    category: "Routine",
    image: "/Kyora_beauty/assets/images/dahonhop.png",
    desc: "Cân bằng giữa làm sạch và dưỡng ẩm.",
    content: `<img src="/Kyora_beauty/assets/images/dahonhop.png">
...

  {
    ...
    category: "Makeup",
    image: "/Kyora_beauty/assets/images/sonbong.png",
    desc: "Son bóng giúp môi căng mọng.",
    content: `<img src="/Kyora_beauty/assets/images/sonbong.png"><p>Phù hợp phong cách trẻ trung.</p>`
  },

  {
    ...
    category: "Skincare",
    image: "/Kyora_beauty/assets/images/sdmatna.png",
    desc: "Không phải đắp càng lâu càng tốt.",
    content: `<img src="/Kyora_beauty/assets/images/sdmatna.png">
...

  {
    ...
    category: "Makeup",
    image: "/Kyora_beauty/assets/images/makengmoi.png",
    desc: "Trang điểm cơ bản dễ thực hiện.",
    content: `<img src="/Kyora_beauty/assets/images/makengmoi.png">
...

  {
    ...
    category: "Routine",
    image: "/Kyora_beauty/assets/images/toichodamun.png",
    desc: "Giúp da nghỉ ngơi và phục hồi.",
    content: `<img src="/Kyora_beauty/assets/images/toichodamun.png">
...

  {
    ...
    category: "Skincare",
    image: "/Kyora_beauty/assets/images/testmypham.png",
    desc: "Bước quan trọng trước khi dùng sản phẩm mới.",
    content: `<img src="/Kyora_beauty/assets/images/testmypham.png">
...

  {
    ...
    category: "Makeup",
    image: "/Kyora_beauty/assets/images/tonehong.png",
    desc: "Phong cách phù hợp đi chơi, hẹn hò.",
    content: `<img src="/Kyora_beauty/assets/images/tonehong.png">
...

  {
    ...
    category: "Routine",
    image: "/Kyora_beauty/assets/images/ngbanron.png",
    desc: "Chỉ 3 bước vẫn đủ hiệu quả.",
    content: `<img src="/Kyora_beauty/assets/images/ngbanron.png">
