const posts = [
  ...
  },
  {
    ...
    category:"Skincare",
    image:"Ảnh/streatment.png",
    desc:"Giúp da nhanh khỏe lại sau peel, laser.",
    content:`<img src="Ảnh/streatment.png">
...

  {
    ...
    category:"Routine",
    image:"Ảnh/skincaremuahe.png",
    desc:"Giữ da thông thoáng, hạn chế đổ dầu.",
    content:`<img src="Ảnh/skincaremuahe.png">
...

  {
    ...
    category:"Makeup",
    image:"Ảnh/makeuptiec.png",
    desc:"Vừa nổi bật vừa không quá đậm.",
    content:`<img src="Ảnh/makeuptiec.png">
...

  {
    ...
    content:`<img src="Ảnh/serum.png"><p>Nên bắt đầu với serum cấp ẩm.</p>`
  },

  {
    ...
    category:"Routine",
    image:"Ảnh/dahonhop.png",
    desc:"Cân bằng giữa làm sạch và dưỡng ẩm.",
    content:`<img src="Ảnh/dahonhop.png">
...

  {
    ...
    category:"Makeup",
    image:"Ảnh/sonbong.png",
    desc:"Son bóng giúp môi căng mọng.",
    content:`<img src="Ảnh/sonbong.png"><p>Phù hợp phong cách trẻ trung.</p>`
  },

  {
    ...
    category:"Skincare",
    image:"Ảnh/sdmatna.png",
    desc:"Không phải đắp càng lâu càng tốt.",
    content:`<img src="Ảnh/sdmatna.png">
...

  {
    ...
    category:"Makeup",
    image:"Ảnh/makengmoi.png",
    desc:"Trang điểm cơ bản dễ thực hiện.",
    content:`<img src="Ảnh/makengmoi.png">
...

  {
    ...
    category:"Routine",
    image:"Ảnh/toichodamun.png",
    desc:"Giúp da nghỉ ngơi và phục hồi.",
    content:`<img src="Ảnh/toichodamun.png">
...

  {
    ...
    category:"Skincare",
    image:"Ảnh/testmypham.png",
    desc:"Bước quan trọng trước khi dùng sản phẩm mới.",
    content:`<img src="Ảnh/testmypham.png">
...

  {
    ...
    category:"Makeup",
    image:"Ảnh/tonehong.png",
    desc:"Phong cách phù hợp đi chơi, hẹn hò.",
    content:`<img src="Ảnh/tonehong.png">
...

  {
    ...
    category:"Routine",
    image:"Ảnh/ngbanron.png",
    desc:"Chỉ 3 bước vẫn đủ hiệu quả.",
    content:`<img src="Ảnh/ngbanron.png">
